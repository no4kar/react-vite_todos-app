...
export const authValidation: TyForm.Validation<TyForm.Auth> = {
  email: {
    required: 'Please, enter your email',
    pattern: {
      value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
      message: `Please, enter the correct format(some@email.com) of your email `,
    },
  },
  password: {
    ...
    pattern: {
      value: /^\w{8,}$/,
      message: `Please, enter the correct format(/^\\w{8,}$/)`,
    },
  },
};
